...
class LoginPage extends JFrame implements ActionListener
{
	...
	LoginPage(MenuClass m1)
	{
		...
		setContentPane(new JLabel(new ImageIcon("pizza.jpg")));
	...
	{
		String x=passt.getText();
		String x2=logint.getText();

		if(ae.getSource()==logint)
		{
			if(logint.getText()==" ")
			{
				JOptionPane.showMessageDialog(null,"Username field is Empty,Enter it first");
				logint.requestFocus();
			}
			else
			{
		...
		else if(ae.getSource()==passt)
		{
			if(passt.getText()==" ")
		    {
				JOptionPane.showMessageDialog(null,"Password field is Empty,Enter it first");
				passt.requestFocus();
			}
			else
			{
		...
		{
			if(x2.equals("mayur") && x.equals("mayur"))
			{
	...
	public void setMyPosition()
	{
		...
		loginhead.setBounds(20,200,100,30);
		p.setBounds(20,240,450,8);
		login.setBounds(20,290,170,30);
		pass.setBounds(20,360,150,30);
		logint.setBounds(220,290,250,40);
		passt.setBounds(220,360,250,40);
		submit.setBounds(70,440,350,40);
	}
	public void setMyFont()
	{
		heading1.setFont(new Font("Baskerville Old Face",Font.BOLD,50));
		heading2.setFont(new Font("Baskerville Old Face",Font.BOLD,60));
		heading3.setFont(new Font("Baskerville Old Face",Font.BOLD,60));
...
class MenuClass extends JFrame implements ActionListener
{
...
class AdJavaProject
{
   public static void main(String args[])
   {
       ...
       LoginPage lp =new LoginPage(new MenuClass());
